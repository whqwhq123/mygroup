    ...
    <el-row>
      <el-row  class="row-bg rightTit" style="border-right: none">
        ...
        <el-col :span='20' style="display: flex;justify-content: flex-end;align-items: center;height: 50px;">
          ...
          <div class="roles_titbutsty2" @click="onoffaddFun(3)">
            保存
          </div>
        </el-col>
      </el-row>
     ...
     <el-row >
        <el-row class="rolenews">
          ...
          <el-row class="rolenews_box" v-if="get_role_function('100200130')">
...
export default {
  ...
  mounted() {
    //  console.log(this.rolespowerdata,"所有权限数据");
    //  console.log(this.rolesseldata,"角色权限数据");
     this.inputValue.roltype=this.rolesInput.roleTypeName
     this.inputValue.isroles=this.rolesInput.roleUseStatus==1?true:false
     this.inputValue.rolname=this.rolesInput.roleName
  ...
  methods: {
    ...
    // console.log(e, functionCode, item,itemchild1,"e, functionCode, item,itemchild1");
    // console.log(this.checkboxData,"checkboxDatacheckboxDatacheckboxData");
